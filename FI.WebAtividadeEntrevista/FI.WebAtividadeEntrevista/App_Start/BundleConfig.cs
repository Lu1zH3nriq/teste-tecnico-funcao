...
namespace FI.WebAtividadeEntrevista
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/formatcpf").Include(
                      "~/Scripts/Clientes/FormatCpf.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/site.css",
                      "~/Content/pageclientes.css",
                      "~/Content/addaltclientes.css",
                      "~/Content/popupbeneficiarios.css"));
